...
# The param block causes issues with AMP exec
<#
param (
    [string]$search_root = "",
...
"@    
    ...
    [string]$ampOutVulJarsPaths = ($vulnerable_java_apps -join ';')
...
"@
    ...
    # Added for AMP exec
    [int32]$ampOutVulJarsFoun = 2
    [string]$ampOutVulJarsPaths = ($unreadable_java_apps -join ';')
